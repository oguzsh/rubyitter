module ApplicationHelper
  ...
  def profile_image(user, options={})
    ...
    classes = "#{size} flex-shrink-0 rounded-full object-cover object-center border-2 border-white"

    if user.profile_image.attached?
      image_tag user.profile_image, class: classes
    else
      image_tag "https://doodleipsum.com/700/avatar-2?i=6c54c7c35a2190dca17dac7ba729c061", class: classes
    end
  end
end
